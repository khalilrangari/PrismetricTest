...
public class DealsAdapter extends RecyclerView.Adapter<DealsAdapter.MyViewHolder> {
  ...
  public DealsAdapter(ArrayList<TrendingModel> trendingModelList, OnItemClickListener onItemClickListener) {
  ...
  public DealsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    View listItem= layoutInflater.inflate(R.layout.item_deals_of_the_day, parent, false);
  ...
  public class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public MyViewHolder(View itemView) {
      super(itemView);
      ivTrending = itemView.findViewById(R.id.ivDealsOfDay);
      tvAmount = itemView.findViewById(R.id.tvOff);
